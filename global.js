...
function appendStatus(data) {
    ...
    if (valuePresent(data.data[0].custbody_lp_status_artwork_setup)) {
        ...
        switch (data.data[0].custbody_lp_status_artwork_setup) {
            case "1":
                custbody_lp_status_artwork_setup = '<p style="display:inline-block;"><b>Artwork Status:</b></p><p> Artwork is complete</p><hr>'//dont show
                break;
            case "2":
                custbody_lp_status_artwork_setup = '<p style="display:inline-block;"><b>Artwork Status:</b></p><p> Artwork being processed</p><hr>'//dont show
                break;
            case "3":
                custbody_lp_status_artwork_setup = '<p style="display:inline-block;"><b>Artwork Status:</b></p><p> ArtWork being revised</p><hr>'
                break;
            case "4":
                custbody_lp_status_artwork_setup = '<p style="display:inline-block;"><b>Artwork Status:</b></p><p> Artwork issues</p><hr>'
                break;
            case "5":
                custbody_lp_status_artwork_setup = '<p style="display:inline-block;"><b>Artwork Status:</b></p><p> transferred</p><hr>'//dont show
                break;
            case "6":
                custbody_lp_status_artwork_setup = '<p style="display:inline-block;"><b>Artwork Status:</b></p><p> pending transfer</p><hr>'//dont show
                break;
            default:
        };
    }
    ...
    if (valuePresent(data.data[0].custbody_lp_status_stock)) {
        ...
        switch (data.data[0].custbody_lp_status_stock) {
            case "1":
                custbody_lp_status_stock = '<p style="display:inline-block;"><b>Stock Status:</b></p> <p> We have the stock to fulfill your order.</p><hr>'//dont show
                break;
            case "2":
                custbody_lp_status_stock = '<p style="display:inline-block;"><b>Stock Status:</b></p> <p> We have unresolved stock issues.</p><hr>'
                break;
            case "3":
                custbody_lp_status_stock = '<p style="display:inline-block;"><b>Stock Status:</b></p> <p> We have resolved stock issues</p><hr>'//dont show
                break;
            default:
        };
    }
    ...
    if (valuePresent(data.data[0].custbody_lp_status_payment)) {
        ...
        switch (data.data[0].custbody_lp_status_artwork_setup) {
            case "1":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> Net Terms</p><hr>'
                break;
            case "2":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> On File</p><hr>'
                break;
            case "3":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> Received</p><hr>'
                break;
            case "4":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> Pending Request</p><hr>'
                break;
            case "5":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> Pending Response</p><hr>'
                break;
            case "6":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> No entity</p><hr>'
                break;
            case "7":
                custbody_lp_status_payment = '<p style="display:inline-block;"><b>Payment Status:</b></p> <p> Credit Card</p><hr>'
                break;
            default:
        };
    }
    if (valuePresent(data.data[0].custbody_lp_status_approval_request)) {
        ...
        switch (data.data[0].custbody_lp_status_approval_request) {
            case "1":
                custbody_lp_status_approval_request = '<p style="display:inline-block;"><b>Approval Status:</b></p><p> Approved</p><hr>' //dont show
                break;
            case "2":
                custbody_lp_status_approval_request = '<p style="display:inline-block;"><b>Approval Status:</b></p><p> Revision Requested</p><hr>'
                break;
            case "3":
                custbody_lp_status_approval_request = '<p style="display:inline-block;"><b>Approval Status:</b></p> <p> Pending Request</p><hr>'
                break;
            case "4":
                custbody_lp_status_approval_request = '<p style="display:inline-block;"><b>Approval Status:</b></p> <p>Pending Response</p><hr>'
                break;
            default:
        };
    }
